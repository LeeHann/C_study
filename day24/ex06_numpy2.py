...
# %%
array_6 = np.random.rand(10)*100
print((array_6).astype(np.int32))

# %%
array_7 = (array_6).astype(np.int32)
print(array_7)
print(np.sort(array_7))

array_8 = (array_6).astype(np.int32)
print(array_8)
print(np.argsort(array_8))

# %%
x1 = np.array([[1,9],[0,8],[6,3],[3,4],[4,1]])
print(x1[:,0])
print(x1[:,1])
